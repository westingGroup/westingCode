...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/assets/js/workflow/workflowDefList.js"></script>
<script type="text/javascript">
	var basePath="<%=request.getContextPath()%>";
	$(function() {
		initWorkflowDefList(1);
	});
</script>
</head>
<body>
	<div class="linklist">
		<h3 style="margin-left: 20px; float: left">工作流定义</h3>
		<div class="tab_search">
			<div>
				<table class="searchTable">
					<tbody>
						<tr>
							<td style="width: 20%;">流程key：</td>
							<td class="right"><input type="text" id="processKey" /></td>
							<td><button class="btn btn-main"
									onclick="initWorkflowDefList(1)">查询</button>
								<button class="btn btn-main" onclick="addWorkflowDef()">新增</button></td>
						</tr>
					</tbody>
				</table>
			</div>
			<div class="linklist">
				...
				<table class="table table-hover table-bordered">
					...
					<tbody id="workflowDefBody"></tbody>
				</table>
				<!-- begin 上一页下一页操作 -->
